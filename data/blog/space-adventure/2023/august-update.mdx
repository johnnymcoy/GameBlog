...
AI now can follow paths. The paths can also be bridged to other paths. Each path
...
Once the AI can see the player, a Detection meter will start to fill up, once
